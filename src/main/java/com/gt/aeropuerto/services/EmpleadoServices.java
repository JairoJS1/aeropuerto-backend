...
public class EmpleadoServices {
    ...
    public List<EmpleadosProjection> ObtenerAllEmpleados() {
        return empleadoRepository.obtenerAllEmpleados();
    }

    public EmpleadosProjection ObtenerEmpleadoByDPI(String dpiEmpleado) {
        return empleadoRepository.obtenerEmpleadobyDPI(dpiEmpleado);
    }
}
